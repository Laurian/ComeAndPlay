...
Audiosearch.prototype.get = function (url, params) {
  var self = this;
  return new Promise(function (resolve, reject) {
    console.log('AudioSearch/get >>', self._creds.host +'/api'+ url);
    var options = {
...
Audiosearch.prototype.getTranscript = function (itemId, audioId) {
  return this.get(
    '/items/'+ itemId +'/audio_files/'+ audioId +'/transcript'
  );
}

Audiosearch.prototype.getContent = function (itemId, audioId) {
  return this.get(
    '/items/'+ itemId +'/audio_files/'+ audioId +'/content_json'
  );
}
